...
class Grader:
    ...
    def __init__(self, entry_number = "2024AIB2291", test_path = './data/misspelling_public.txt', training_paths = ['./data/train1.txt', './data/train2.txt']):
    ...
    def grade(self, test_mode = False):
        ...
        df = pd.concat([df, pd.DataFrame([{'corrupt': 'Score', 'truth': sc, 'prediction': sc}])], ignore_index=True)
